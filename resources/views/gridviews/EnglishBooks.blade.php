                ...
                <ul>
                    @if($data->isEmpty())
                        <div class="alert alert-warning text-warning text-center" role="alert">
                            <strong>No books found!</strong> Please check back later or try a different search.
                        </div>
                    @else
                                    ...
                                    <div class="post-detail">
                                        ...
                                        <header class="entry-header">
                                            <h3 class="entry-title">
                                                <a href="{{ url('final-page/' . $info->id) }}">{{ $info->Book_Name }}</a>
                                            </h3>
                                            <ul>
                                        ...
                                        <div class="entry-content">
                                            <p>Go ahead and explore, read, and access this book freely.</p>
                                        </div>
